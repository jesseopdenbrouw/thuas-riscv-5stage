...
package body jtag_dmi_pkg is
  ...
  procedure jtag_shift_ir(
    ...
    signal   core_tdi : out std_logic;
    signal   core_tdo : in  std_logic;
    constant ir       : in  std_logic_vector(4 downto 0)
  ) is
    variable tdo_v : std_logic;
  begin
  ...
  procedure dmi_write(
    ...
    variable dmi_in_v, dmi_out_v : std_logic_vector(40 downto 0);
  begin
